...
def k_fold_validation(model_name,
    ...
    for fold, (train_idx, val_idx) in enumerate(skf.split(np.zeros(len(labels)), labels)):
        ...
        for epoch in range(epochs + 1):
            ...
            if epoch != epochs:
                ...
                rf_validation_accuracy, rf_pred, svm_validation_accuracy, svm_pred, y_pred_knn, y_pred_ensemble, knn_validation_accuracy, et_validation_accuracy, y_pred_et, ensemble_validation_accuracy = train_models(X_train, y_train, X_val, y_val)
                ...
                rf_validation_accuracy_rad, rf_pred_rad, svm_validation_accuracy_rad, svm_pred_rad, y_pred_knn_rad, y_pred_ensemble_rad, knn_validation_accuracy_rad, et_validation_accuracy_rad, y_pred_et_rad, ensemble_validation_accuracy_rad = train_models(X_train_radiomics, y_train, X_val_radiomics, y_val)
    ...
    writer.add_figure("3D CNN Feature Extractor + KNN Classifier", plot_confusion_matrix(conf_matr_labels, knn_conf_matr_pred, "3D CNN Feature Extractor + KNN Classifier"))
    ...
    writer.add_figure("3D CNN Feature Extractor With Radiomic Features + KNN Classifier", plot_confusion_matrix(conf_matr_labels, knn_conf_matr_pred_rad, "3D CNN Feature Extractor With Radiomic Features + KNN Regression Classifier"))
...
def train_models(X_train, y_train, X_val, y_val):
    ...
    return rf_validation_accuracy, y_pred_rf, svm_validation_accuracy, y_pred_svm, y_pred_knn, y_pred_ensemble, knn_validation_accuracy, et_validation_accuracy, y_pred_et, ensemble_validation_accuracy
